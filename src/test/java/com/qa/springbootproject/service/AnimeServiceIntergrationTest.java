...
@SpringBootTest
public class AnimeServiceIntergrationTest {
		...
		public void testReadByName() {
			...
			anime = new Anime(1,"Samurai Champloo", 11.0, true, "A truly underrated classic.");
...
//			assertEquals(service.deleteAnimeById(id));
		...
		public void testDelete() {
			anime = new Anime (2, " something", 8, false, "something");
